...
from unicode_charnames import (
    charname, codepoint, search_charnames, UNICODE_VERSION, UCD_VERSION
)
...
class TestSuite(unittest.TestCase):
    ...
    def test_UCD_VERSION(self):
        self.assertEqual(UCD_VERSION, '13.0.0')
